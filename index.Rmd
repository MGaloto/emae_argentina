...
<script>
document.querySelector(".navbar-header > span.navbar-brand > span.navbar-author").innerHTML = "Estimador Mensual de la Actividad Economica. Fuente: Indec. Ultima Actualizacion:`r last_update`";
</script>
...
Este Dashboard tiene la finalidad de mostrarnos las principales métricas de los distintos sectores que tienen medición mensual de la evolución de la actividad económica.
